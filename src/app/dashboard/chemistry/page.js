        ...
        <div className="bg-gray-900 py-10 min-h-screen overflow-hidden dark:bg-black dark:bg-grid-small-white/[0.2] bg-grid-small-white/[0.2] ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {chemistryBranches.map((branch, index) => (
                    <div key={index} className="bg-orange-200 text- shadow-md rounded-lg p-4 mx-4 transition-transform duration-300 hover:scale-105">
                        ...
                        <p className="text-gray-900 text-sm opacity-50" >{branch.description}</p>
                    </div>
                ))}
            </div>
        </div>
