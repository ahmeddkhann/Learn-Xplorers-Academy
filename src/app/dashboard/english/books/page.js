...
import { literatureBooks } from '@/app/data'; // Adjust the import path as necessary
    ...
    return (
        <div className="bg-gray-900 py-10 min-h-screen">
            ...
            <div className="container mx-auto mt-8 p-4">
                <h1 className="text-4xl font-bold text-white text-center mb-6">Literature Books</h1>
            </div>
        ...
        {literatureBooks.map((book, index) => (
          <BackgroundGradient key={index} className="rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105 p-4">
           ...
           <Link href={"#"} className='bg-gray-200 hover:bg-gray-400 px-3 py-2 rounded-lg '>
              Read more
           </Link>
           </div>
            </div>
