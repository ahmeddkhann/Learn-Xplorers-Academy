      ...
      <main className="flex-1 p-6 lg:ml-60 flex flex-col items-start overflow-y-auto">
        ...
        <section className="grid gap-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 w-full">
          {courses.map((course) => (
            <div
              key={course.id}
              className="bg-gray-700 rounded-lg hover:translate-x-3 hover:translate-y-4 opacity-50 hover:opacity-100 hover:bg-gray-900 hover:shadow-white hover:shadow-2xl
